...
U8G2_ST7920_128X64_1_HW_SPI u8g2(U8G2_R0, /* CS=*/ A1, /* reset=*/ U8X8_PIN_NONE);
//U8G2_ST7920_128X64_1_HW_SPI u8g2(U8G2_R0, /* CS=*/ RS_CS, /* reset=*/ U8X8_PIN_NONE);

volatile byte lcdFlag=0;

#define UPDATE_LCD_TIME 250
