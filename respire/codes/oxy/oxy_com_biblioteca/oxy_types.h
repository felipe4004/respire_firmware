...
// EEPROM DIR
#define EE_EQU 0
#define EE_RES 50       // MUDANCA DE ENDERECO
#define EE_ALA 80
#define EE_RAL 120
#define EE_STA 160
...
typedef uint16_t fixed_point_t; // Tipo para ponto fixo
//------END TYPEDEFS
...
struct alarmConfig_type { // Valores limite que disparam o alarme
